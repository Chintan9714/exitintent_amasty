...
namespace Amasty\ExitPopup\Block\Adminhtml\System\Config;
...
class Information extends Fieldset
{
     ...
     * @var string
     */
    private $userGuide = 'https://amasty.com/docs/doku.php?id=magento_2:exit-intent-popup&utm_source=extension'
    . '&utm_medium=backend&utm_campaign=exit-popup-guide';
