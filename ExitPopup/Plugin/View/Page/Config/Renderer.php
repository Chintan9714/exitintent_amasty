...
namespace Amasty\ExitPopup\Plugin\View\Page\Config;
...
class Renderer
{
    const CACHE_KEY = 'amasty_exitpopup_should_load_css_file';
    ...
    public function beforeRenderAssets(
        ...
        if ($shouldLoad) {
            $this->config->addPageAsset('Amasty_ExitPopup::css/source/mkcss/amexit.css');
        }
